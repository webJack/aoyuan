<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\wamp64\www\aoyuan\public/../application/admin\view\user\index.html";i:1507012938;s:72:"D:\wamp64\www\aoyuan\public/../application/admin\view\public\header.html";i:1507011938;s:72:"D:\wamp64\www\aoyuan\public/../application/admin\view\public\footer.html";i:1501302147;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid" cz-shortcut-listen="true">
 ...
 <a href="<?php echo url('add'); ?>" class="btn btn-info">添加用户</a>
    <h2>用户管理界面</h2>
    <div class="row">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><?php echo !empty($value['status']) && $value['status']==1?'√':'×'; ?></td>
            <td>
                <a href="<?php echo url('auditing',['id'=>$value['id']]); ?>" class="btn btn-primary">成为专家</a>
    ...
    <div><?php echo $user_list->render(); ?></div>
