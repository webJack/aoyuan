<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\15\tp5\public/../application/admin\view\vip\index.html";i:1507010603;s:96:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\15\tp5\public/../application/admin\view\public\header.html";i:1507011938;s:96:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\15\tp5\public/../application/admin\view\public\footer.html";i:1501302147;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid" cz-shortcut-listen="true">
 ...
 <a href="<?php echo url('add'); ?>" class="btn btn-info">添加专家</a>
    <h2>专家管理界面</h2>
    <div class="row">
    ...
    <table class="table">
        ...
        <?php foreach($vip_list as $value): ?>
        <tr>
            <td><?php echo $value['id']; ?></td>
            <td><?php echo $value['vip_uid']; ?></td>
            <td><?php echo $value['vip_money']; ?></td>
            <td><?php echo date("Y-m-d H:i:s",$value['add_time']); ?></td>
            <td><?php echo !empty($value['is_real']) && $value['is_real']==1?'认证':'未认证'; ?></td>
    ...
    <div><?php echo $vip_list->render(); ?></div>
