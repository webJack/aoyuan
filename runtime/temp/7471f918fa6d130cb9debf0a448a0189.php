<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:96:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\15\tp5\public/../application/admin\view\user\auditing.html";i:1507014887;s:96:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\15\tp5\public/../application/admin\view\public\header.html";i:1507011938;s:96:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\15\tp5\public/../application/admin\view\public\footer.html";i:1501302147;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid" cz-shortcut-listen="true">
     ...
     <form action="<?php echo url('save'); ?>" method="post">
        ...
        <div class="form-group">
            <a href="<?php echo url('create_vip',['uid'=>$user_info['id']]); ?>" class="btn btn-info">审核通过</a>
            <a class="btn btn-danger" onclick="$('.info_box').show()">审核不通过</a>
        </div>
        <div class="info_box" style="display: none;">
            <form action="" >
                <textarea rows="10" style="resize: none;" cols="40" name=""></textarea>
                <input type="submit" style="margin-bottom: 25px;" class="btn btn-info">
            </form>            
        </div>
     </form>
