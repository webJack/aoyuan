<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:94:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\aoyuan\public/../application/index\view\index\index.html";i:1509463823;s:96:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\aoyuan\public/../application/index\view\common\header.html";i:1509464089;s:96:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\aoyuan\public/../application/index\view\common\footer.html";i:1509454245;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="carousel">
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="__STATIC_PATH__/index/index/images/banner1.jpg"/></div>
            <div class="swiper-slide"><img src="__STATIC_PATH__/index/index/images/banner2.jpg"/></div>
            <div class="swiper-slide"><img src="__STATIC_PATH__/index/index/images/banner3.jpg"/></div>
            <div class="swiper-slide"><img src="__STATIC_PATH__/index/index/images/banner4.jpg"/></div>
        </div>
    </div>
</div>
<div class="about">
    <div class="about-container">
        <div class="about-nav">
            <ul class="about-wrapper">
                <li class="about-item wow slideInUp " data-wow-delay="0.1s">
                    <img src="__STATIC_PATH__/index/index/images/top-nav_05.jpg" alt="">
                </li>
                <li class="about-item wow slideInUp" data-wow-delay="0.3s">
                    <img src="__STATIC_PATH__/index/index/images/top-nav_02_05.jpg" alt="">
                </li>
                <li class="about-item wow slideInUp" data-wow-delay="0.5s">
                    <img src="__STATIC_PATH__/index/index/images/top-nav3_05.jpg" alt="">
                </li>
            </ul>
        </div>
        ...
        <div class="content">
            <div class="content-left wow slideInLeft">
                <h2>专业/服务/创新</h2>
                <p>广州源酷信息科技有限公司（澳源股份）成立于中国广告业和电子商务业发展迅猛的21世纪初，由
                    国内知名的金融证券公司和房地产商投资广州源酷信息科技有限公司团队始创于2010年，于2012年正
                    广州源酷信息科技有限公司（澳源股份）成立于中国广告业和电子商务业发展迅猛的21世纪初，0年，于2012年正
                    广州源酷信息科技有限公司（澳源股份）成立于中国广告业和电子商务业发展迅猛的21世纪初0年，于2012年正
                    广州源酷信息科技有限公司（澳源股份）成立于中国广告业和电子商务业发展迅猛的21世纪初
                </p>
                <p> 式在工商登记注册，公司坐落于广州市。公司自成立以来一直专注互联网技术服务和高端IT人才解决方案
                    ，源酷科技依靠专业的技术团队为客户提供：品牌策划、互联网开发、电商运营、高校专业化项目实训等服务。</p>
            </div>
...
<div class="team">
    <div class="team-container">
        ...
        <ul class="team-list">
            ...
            <li class="team-list-item wow slideInUp" data-wow-delay="0.5s">
            ...
            <li class="team-list-item wow slideInUp" data-wow-delay="0.7s">
...
<div class="school-l">
    ...
    <ul class="school-list wow slideInUp">
        ...
        <li class="school-list-item"><img src="__STATIC_PATH__/index/index/images/school_07.jpg" class="school1"></li>
        ...
        <li class="school-list-item"><img src="__STATIC_PATH__/index/index/images/school1_13.jpg" class="school1"></li>
        <li class="school-list-item"><img src="__STATIC_PATH__/index/index/images/school1_20.jpg" class="school1"></li>
        <li class="school-list-item"><img src="__STATIC_PATH__/index/index/images/school1_22.jpg" class="school1"></li>
        <li class="school-list-item"><img src="__STATIC_PATH__/index/index/images/school1_24.jpg" class="school1"></li>
        <li class="school-list-item"><img src="__STATIC_PATH__/index/index/images/school1_26.jpg" class="school1"></li>
        <li class="school-list-item"><img src="__STATIC_PATH__/index/index/images/school1_28.jpg" class="school1"></li>
        <li class="school-list-item"><img src="__STATIC_PATH__/index/index/images/school1_29.jpg" class="school1"></li>
    </ul>
</div>
