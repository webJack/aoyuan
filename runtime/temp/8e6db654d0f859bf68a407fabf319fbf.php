<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\15\tp5\public/../application/admin\view\category\add.html";i:1505789482;s:96:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\15\tp5\public/../application/admin\view\public\header.html";i:1507011938;s:96:"C:\WAMP\Apache-2.4.20\Apache24\htdocs\15\tp5\public/../application/admin\view\public\footer.html";i:1501302147;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
     ...
     <form action="<?php echo url('save'); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <select name="parent_id" id="">
                <option value="0_0">请选择</option>
                <?php foreach($cate_list as $value): ?>
                    <option value="<?php echo $value['id']; ?>_<?php echo $value['level']; ?>"><?php echo $value['cate_name']; ?></option>
                       <!-- <?php if (isset($value['child_menu'])){ ?> -->
                    <!-- <?php foreach($value['child_menu'] as $second_value): ?> -->
                            <option   value="<?php echo $second_value['id']; ?>_<?php echo $second_value['level']; ?>" style="padding-left:20px;color: red;"><?php echo $second_value['cate_name']; ?></option>
