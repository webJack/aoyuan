...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid" cz-shortcut-listen="true">
    ...
    <table class="table">
        ...
        <?php foreach($count_list as $value): ?>
        <tr>
            <td><?php echo $value['id']; ?></td>
            <td><?php echo $value['uid']; ?></td>
            <td><?php echo $value['answer_count']; ?></td>
            <td><?php echo $value['follow_count']; ?></td>
            <td><?php echo $value['receive_count']; ?></td>
    ...
    <div><?php echo $count_list->render(); ?></div>
